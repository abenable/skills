...
description: 本地/私有 Claw Skill Nest（虾滑 / Xiashua）客户端，支持列出、上传、安装、更新技能；用于 local/private claw-skill-nest、虾滑、本地 Skill 管理中心等场景，不用于 clawhub.com。
---

# Local Claw Skill Nest Client

本技能是 **本地/私有 Claw Skill Nest（虾滑 / Xiashua）客户端**，用于管理 skills：
...
- `在虾滑里列出 skills`
- `把这个 skill 上传到虾滑`
- `从虾滑安装 <name>` / `从虾滑更新 <name>`
- `使用 Xiashua 管理本地 skills`
